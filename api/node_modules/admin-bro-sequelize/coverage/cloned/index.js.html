...
<html lang="en">
<head>
    <title>Code coverage report for cloned/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">cloned</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable @typescript-eslint/no-var-requires */
/**
 ...
 * @static
 */
const Database = <span class="cstat-no" title="statement not covered" >require('./build/database').default</span>
&nbsp;
/**
 ...
 * @static
 */
const Resource = <span class="cstat-no" title="statement not covered" >require('./build/resource').default</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = { Database, Resource }</span>
&nbsp;</pre></td></tr>
</table></pre>
